...
type Mutation {
  ...
  requesterLogin(userName: String!, password: String!): requesterAuth
    addDeveloper(userName: String!, firstName: String!, lastName: String!, email: String!,
password: String!): developerAuth
    addRequester(userName: String!, firstName: String!, lastName: String!, email: String!,
password: String!): requesterAuth
