...
const ProfilePage = () => {
  ...
  return (
    <>
      <section className="block p-6 rounded-lg shadow-lg bg-gradient-to-br from-neutral-focus to-slate-400 max-w-md md:col-start-6 md:col-span-6 col-start-3 col-span-8 my-12">
