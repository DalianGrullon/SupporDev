        ...
        <div className="text-primary bg-base-100 col-span-8 col-start-4 row-span-4 row-start-2 mx-auto">
            <div className="card w-auto bg-info text-info-content shadow-2xl">
                <div className="card-body">
                    ...
                    <p className="text-xl">Do you need web development work done and are unable to afford a complete solution? Are you a developer who needs to hone your skills with real world experience? If so, SupporDev is the place for you!</p>
